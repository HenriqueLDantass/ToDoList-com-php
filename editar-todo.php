                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <form action="editar-dados-action.php" method="POST">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        <!--input nome-->
                                        <div class="form-outline form-white mb-4">
                                            <label class="form-label" for="typeEmailX">tarefa</label>
                                            <input type="text" class="form-control form-control-lg" value="<?= $dados['atividas'] ?>" name="nome" required />
                                            <!--input alterar-->
                                            <input class=" btn btn-outline-light btn-lg px-10 mt-5" type="submit" value="Alterar">
                                        </div>
                                </form>
                            </div>
                        </div>
